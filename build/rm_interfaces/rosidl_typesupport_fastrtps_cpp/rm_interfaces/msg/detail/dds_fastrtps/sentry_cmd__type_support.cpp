...
#include "rm_interfaces/msg/detail/sentry_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rm_interfaces::msg::SentryCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rm_interfaces::msg::SentryCmd & ros_message)
{
  // Member: resurrection_en
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rm_interfaces::msg::SentryCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rm_interfaces::msg::SentryCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rm_interfaces::msg::SentryCmd *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SentryCmd__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rm_interfaces::msg::SentryCmd *>(
...
static size_t _SentryCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SentryCmd(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SentryCmd__callbacks = {
  "rm_interfaces::msg",
  "SentryCmd",
...
static rosidl_message_type_support_t _SentryCmd__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SentryCmd__callbacks,
...
{
  return &rm_interfaces::msg::typesupport_fastrtps_cpp::_SentryCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rm_interfaces, msg, SentryCmd)() {
  return &rm_interfaces::msg::typesupport_fastrtps_cpp::_SentryCmd__handle;
}
