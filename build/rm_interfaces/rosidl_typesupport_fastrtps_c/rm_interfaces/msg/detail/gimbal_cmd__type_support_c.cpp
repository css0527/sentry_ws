...
#include "rm_interfaces/msg/detail/gimbal__functions.h"  // position, velocity
  ...
  // Field name: position
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rm_interfaces, msg, Gimbal
      )()->data);
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_rm_interfaces__msg__Gimbal(
  ...
  size_t current_alignment)
{
  ...
  // member: position
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_rm_interfaces__msg__Gimbal(
