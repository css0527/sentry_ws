...
class Metaclass_ShootCmd(type):
    ...
    def STOP(self):
        ...
        return Metaclass_ShootCmd.__constants['STOP']

    @property
    def ONCE(self):
        """Message constant 'ONCE'."""
        return Metaclass_ShootCmd.__constants['ONCE']

    @property
    def CONTINUOUS(self):
        """Message constant 'CONTINUOUS'."""
        return Metaclass_ShootCmd.__constants['CONTINUOUS']
