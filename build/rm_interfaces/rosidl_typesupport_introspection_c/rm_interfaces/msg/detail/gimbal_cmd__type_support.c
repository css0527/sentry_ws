...
// Member `position`
// Member `velocity`
#include "rm_interfaces/msg/gimbal.h"
// Member `position`
// Member `velocity`
...
static rosidl_typesupport_introspection_c__MessageMember rm_interfaces__msg__GimbalCmd__rosidl_typesupport_introspection_c__GimbalCmd_message_member_array[4] = {
  {
    ...
    offsetof(rm_interfaces__msg__GimbalCmd, yaw_type),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces__msg__GimbalCmd, pitch_type),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces__msg__GimbalCmd, position),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces__msg__GimbalCmd, velocity),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_interfaces, msg, GimbalCmd)() {
  rm_interfaces__msg__GimbalCmd__rosidl_typesupport_introspection_c__GimbalCmd_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_interfaces, msg, Gimbal)();
  rm_interfaces__msg__GimbalCmd__rosidl_typesupport_introspection_c__GimbalCmd_message_member_array[3].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_interfaces, msg, Gimbal)();
