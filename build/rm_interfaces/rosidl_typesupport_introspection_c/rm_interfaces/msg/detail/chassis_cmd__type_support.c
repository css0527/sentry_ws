...
static rosidl_typesupport_introspection_c__MessageMember rm_interfaces__msg__ChassisCmd__rosidl_typesupport_introspection_c__ChassisCmd_message_member_array[2] = {
  {
    "type",  // name
    ...
    offsetof(rm_interfaces__msg__ChassisCmd, type),  // bytes offset in struct
    NULL,  // default value
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rm_interfaces, msg, ChassisCmd)() {
  rm_interfaces__msg__ChassisCmd__rosidl_typesupport_introspection_c__ChassisCmd_message_member_array[1].members_ =
