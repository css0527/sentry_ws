...
static rosidl_typesupport_introspection_c__MessageMember rm_interfaces__msg__GameState__rosidl_typesupport_introspection_c__GameState_message_member_array[11] = {
  {
    "current_hp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rm_interfaces__msg__GameState, enemy_outpost_occupied),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
