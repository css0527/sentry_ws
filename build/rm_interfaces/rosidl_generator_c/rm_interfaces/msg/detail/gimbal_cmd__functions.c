...
rm_interfaces__msg__GimbalCmd__init(rm_interfaces__msg__GimbalCmd * msg)
{
  ...
  msg->pitch_type = 1;
  // position
  if (!rm_interfaces__msg__Gimbal__init(&msg->position)) {
    rm_interfaces__msg__GimbalCmd__fini(msg);
    return false;
  }
  // velocity
  if (!rm_interfaces__msg__Gimbal__init(&msg->velocity)) {
    rm_interfaces__msg__GimbalCmd__fini(msg);
    return false;
  }
  return true;
...
rm_interfaces__msg__GimbalCmd__fini(rm_interfaces__msg__GimbalCmd * msg)
{
  ...
  // pitch_type
  // position
  rm_interfaces__msg__Gimbal__fini(&msg->position);
  // velocity
  rm_interfaces__msg__Gimbal__fini(&msg->velocity);
}
...
rm_interfaces__msg__GimbalCmd__are_equal(const rm_interfaces__msg__GimbalCmd * lhs, const rm_interfaces__msg__GimbalCmd * rhs)
{
  ...
  // position
  if (!rm_interfaces__msg__Gimbal__are_equal(
