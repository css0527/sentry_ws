...
{
  new (message_memory) auto_aim_interfaces::msg::OperatorCommand(_init);
}

void OperatorCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<auto_aim_interfaces::msg::OperatorCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember OperatorCommand_message_member_array[3] = {
  {
    ...
    offsetof(auto_aim_interfaces::msg::OperatorCommand, is_retreating),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auto_aim_interfaces::msg::OperatorCommand, is_drone_avoiding),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auto_aim_interfaces::msg::OperatorCommand, is_outpost_attacking),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers OperatorCommand_message_members = {
  ...
  3,  // number of fields
  sizeof(auto_aim_interfaces::msg::OperatorCommand),
...
{
  return &::auto_aim_interfaces::msg::rosidl_typesupport_introspection_cpp::OperatorCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auto_aim_interfaces, msg, OperatorCommand)() {
  return &::auto_aim_interfaces::msg::rosidl_typesupport_introspection_cpp::OperatorCommand_message_type_support_handle;
}
