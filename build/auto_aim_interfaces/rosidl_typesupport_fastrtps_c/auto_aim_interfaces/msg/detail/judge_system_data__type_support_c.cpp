...
#include "auto_aim_interfaces/msg/detail/judge_system_data__rosidl_typesupport_fastrtps_c.h"
...
#include "auto_aim_interfaces/msg/detail/operator_command__functions.h"  // operator_command
...
using _JudgeSystemData__ros_msg_type = auto_aim_interfaces__msg__JudgeSystemData;
  ...
  // Field name: operator_command
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, auto_aim_interfaces, msg, OperatorCommand
      )()->data);
...
size_t get_serialized_size_auto_aim_interfaces__msg__JudgeSystemData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _JudgeSystemData__ros_msg_type * ros_message = static_cast<const _JudgeSystemData__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_auto_aim_interfaces__msg__OperatorCommand(
...
static uint32_t _JudgeSystemData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auto_aim_interfaces__msg__JudgeSystemData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_auto_aim_interfaces
size_t max_serialized_size_auto_aim_interfaces__msg__JudgeSystemData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: operator_command
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_auto_aim_interfaces__msg__OperatorCommand(
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces__msg__JudgeSystemData;
    is_plain =
      (
...
static size_t _JudgeSystemData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_auto_aim_interfaces__msg__JudgeSystemData(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auto_aim_interfaces, msg, JudgeSystemData)() {
