  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: pitch_diff
  {
    cdr << ros_message->pitch_diff;
  }
  ...
  // Field name: fire_advice
  {
    cdr << (ros_message->fire_advice ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: fire_advice
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->fire_advice = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name pitch_diff
  {
    size_t item_size = sizeof(ros_message->pitch_diff);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name distance
  ...
  // field.name fire_advice
  {
    size_t item_size = sizeof(ros_message->fire_advice);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
