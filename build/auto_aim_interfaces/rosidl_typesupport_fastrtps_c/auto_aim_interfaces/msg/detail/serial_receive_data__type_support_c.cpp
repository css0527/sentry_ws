...
#include "auto_aim_interfaces/msg/detail/serial_receive_data__rosidl_typesupport_fastrtps_c.h"
...
#include "auto_aim_interfaces/msg/detail/game_state__functions.h"  // gamestate
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_auto_aim_interfaces__msg__GameState(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_auto_aim_interfaces__msg__GameState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auto_aim_interfaces, msg, GameState)();
...
using _SerialReceiveData__ros_msg_type = auto_aim_interfaces__msg__SerialReceiveData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: gamestate
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, auto_aim_interfaces, msg, GameState
      )()->data);
    if (!callbacks->cdr_serialize(
        &ros_message->gamestate, cdr))
    {
      return false;
    }
  }
...
size_t get_serialized_size_auto_aim_interfaces__msg__SerialReceiveData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SerialReceiveData__ros_msg_type * ros_message = static_cast<const _SerialReceiveData__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_auto_aim_interfaces__msg__GameState(
    &(ros_message->gamestate), current_alignment);
...
static uint32_t _SerialReceiveData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auto_aim_interfaces__msg__SerialReceiveData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_auto_aim_interfaces
size_t max_serialized_size_auto_aim_interfaces__msg__SerialReceiveData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: gamestate
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_auto_aim_interfaces__msg__GameState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces__msg__SerialReceiveData;
    is_plain =
      (
      offsetof(DataType, gamestate) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _SerialReceiveData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_auto_aim_interfaces__msg__SerialReceiveData(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auto_aim_interfaces, msg, SerialReceiveData)() {
