...
#include "auto_aim_interfaces/msg/detail/rune_target__rosidl_typesupport_fastrtps_c.h"
...
#include "auto_aim_interfaces/msg/detail/point2d__functions.h"  // pts
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_auto_aim_interfaces__msg__Point2d(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_auto_aim_interfaces__msg__Point2d(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auto_aim_interfaces, msg, Point2d)();
...
using _RuneTarget__ros_msg_type = auto_aim_interfaces__msg__RuneTarget;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: pts
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, auto_aim_interfaces, msg, Point2d
      )()->data);
    size_t size = 5;
...
size_t get_serialized_size_auto_aim_interfaces__msg__RuneTarget(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RuneTarget__ros_msg_type * ros_message = static_cast<const _RuneTarget__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name pts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_auto_aim_interfaces__msg__Point2d(
...
static uint32_t _RuneTarget__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auto_aim_interfaces__msg__RuneTarget(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_auto_aim_interfaces
size_t max_serialized_size_auto_aim_interfaces__msg__RuneTarget(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: pts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_auto_aim_interfaces__msg__Point2d(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces__msg__RuneTarget;
    is_plain =
      (
...
static size_t _RuneTarget__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_auto_aim_interfaces__msg__RuneTarget(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, auto_aim_interfaces, msg, RuneTarget)() {
