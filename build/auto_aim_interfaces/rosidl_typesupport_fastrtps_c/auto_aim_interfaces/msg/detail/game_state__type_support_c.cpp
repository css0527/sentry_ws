...
#include "auto_aim_interfaces/msg/detail/game_state__rosidl_typesupport_fastrtps_c.h"
...
using _GameState__ros_msg_type = auto_aim_interfaces__msg__GameState;
...
static uint32_t _GameState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_auto_aim_interfaces__msg__GameState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces__msg__GameState;
    is_plain =
      (
...
static size_t _GameState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_auto_aim_interfaces__msg__GameState(
