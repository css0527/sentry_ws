...
#include "auto_aim_interfaces/msg/detail/rune_target__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const auto_aim_interfaces::msg::Point2d &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  auto_aim_interfaces::msg::Point2d &);
size_t get_serialized_size(
  const auto_aim_interfaces::msg::Point2d &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const auto_aim_interfaces::msg::RuneTarget & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  auto_aim_interfaces::msg::RuneTarget & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_auto_aim_interfaces
max_serialized_size_RuneTarget(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: pts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        auto_aim_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Point2d(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces::msg::RuneTarget;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const auto_aim_interfaces::msg::RuneTarget *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auto_aim_interfaces::msg::RuneTarget *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RuneTarget__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const auto_aim_interfaces::msg::RuneTarget *>(
...
static size_t _RuneTarget__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RuneTarget(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RuneTarget__callbacks = {
...
static rosidl_message_type_support_t _RuneTarget__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RuneTarget__callbacks,
...
{
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_RuneTarget__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auto_aim_interfaces, msg, RuneTarget)() {
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_RuneTarget__handle;
}
