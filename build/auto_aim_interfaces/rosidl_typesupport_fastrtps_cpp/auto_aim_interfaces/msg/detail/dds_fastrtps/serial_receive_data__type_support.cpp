...
#include "auto_aim_interfaces/msg/detail/serial_receive_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const auto_aim_interfaces::msg::GameState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const auto_aim_interfaces::msg::SerialReceiveData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  auto_aim_interfaces::msg::SerialReceiveData & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: gamestate
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        auto_aim_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_GameState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces::msg::SerialReceiveData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const auto_aim_interfaces::msg::SerialReceiveData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auto_aim_interfaces::msg::SerialReceiveData *>(
    untyped_ros_message);
...
{
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_SerialReceiveData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auto_aim_interfaces, msg, SerialReceiveData)() {
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_SerialReceiveData__handle;
}
