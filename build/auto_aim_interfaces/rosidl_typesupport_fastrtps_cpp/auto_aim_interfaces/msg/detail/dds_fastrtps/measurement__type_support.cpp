...
#include "auto_aim_interfaces/msg/detail/measurement__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const auto_aim_interfaces::msg::Measurement & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  auto_aim_interfaces::msg::Measurement & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces::msg::Measurement;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const auto_aim_interfaces::msg::Measurement *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auto_aim_interfaces::msg::Measurement *>(
    untyped_ros_message);
...
{
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_Measurement__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auto_aim_interfaces, msg, Measurement)() {
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_Measurement__handle;
}
