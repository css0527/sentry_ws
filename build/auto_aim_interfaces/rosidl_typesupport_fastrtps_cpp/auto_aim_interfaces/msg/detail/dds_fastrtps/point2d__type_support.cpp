...
#include "auto_aim_interfaces/msg/detail/point2d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const auto_aim_interfaces::msg::Point2d & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  auto_aim_interfaces::msg::Point2d & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = auto_aim_interfaces::msg::Point2d;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const auto_aim_interfaces::msg::Point2d *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<auto_aim_interfaces::msg::Point2d *>(
    untyped_ros_message);
...
{
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_Point2d__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, auto_aim_interfaces, msg, Point2d)() {
  return &auto_aim_interfaces::msg::typesupport_fastrtps_cpp::_Point2d__handle;
}
