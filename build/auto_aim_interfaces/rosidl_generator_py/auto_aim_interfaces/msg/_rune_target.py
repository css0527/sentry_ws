    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'auto_aim_interfaces.msg.RuneTarget')
            logger.debug(
            ...
            from auto_aim_interfaces.msg import Point2d
...
class RuneTarget(metaclass=Metaclass_RuneTarget):
    ...
    _fields_and_field_types = {
        ...
        'pts': 'auto_aim_interfaces/Point2d[5]',
        'is_lost': 'boolean',
        'is_big_rune': 'boolean',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['auto_aim_interfaces', 'msg'], 'Point2d'), 5),  # noqa: E501
