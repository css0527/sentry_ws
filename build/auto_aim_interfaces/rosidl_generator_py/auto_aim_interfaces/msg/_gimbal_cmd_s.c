...
bool auto_aim_interfaces__msg__gimbal_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("auto_aim_interfaces.msg._gimbal_cmd.GimbalCmd", full_classname_dest, 45) == 0);
  }
  auto_aim_interfaces__msg__GimbalCmd * ros_message = _ros_message;
  {  // header
...
PyObject * auto_aim_interfaces__msg__gimbal_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("auto_aim_interfaces.msg._gimbal_cmd");
