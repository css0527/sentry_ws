    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'auto_aim_interfaces.msg.SerialReceiveData')
            logger.debug(
            ...
            from auto_aim_interfaces.msg import GameState
            if GameState.__class__._TYPE_SUPPORT is None:
                GameState.__class__.__import_type_support__()
...
class SerialReceiveData(metaclass=Metaclass_SerialReceiveData):
    ...
    _fields_and_field_types = {
        ...
        'yaw': 'float',
        'pitch': 'float',
        'gamestate': 'auto_aim_interfaces/GameState',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('float'),  # noqa: E501
        rosidl_parser.definition.BasicType('float'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['auto_aim_interfaces', 'msg'], 'GameState'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from auto_aim_interfaces.msg import GameState
        self.gamestate = kwargs.get('gamestate', GameState())
    ...
    def gamestate(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'gamestate' field must be a sub message of type 'GameState'"
