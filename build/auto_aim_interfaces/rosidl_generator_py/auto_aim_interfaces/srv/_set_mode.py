...
class Metaclass_SetMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'auto_aim_interfaces.srv.SetMode')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from auto_aim_interfaces.srv import _set_mode
...
class SetMode(metaclass=Metaclass_SetMode):
    from auto_aim_interfaces.srv._set_mode import SetMode_Request as Request
    from auto_aim_interfaces.srv._set_mode import SetMode_Response as Response
