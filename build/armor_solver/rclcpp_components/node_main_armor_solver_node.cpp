...
#define NODE_MAIN_LOGGER_NAME "armor_solver_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libarmor_solver.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<fyt::auto_aim::ArmorSolverNode>";
