...
auto_aim_interfaces::msg::GimbalCmd Solver::solve(const auto_aim_interfaces::msg::Target &target,
  ...
  // {
  //  pitch_offset = (angle_offset[0]-0.9) * M_PI / 180 ;
  //  yaw_offset = (angle_offset[1]+0.3) * M_PI / 180;
  // }
  ...
  // {
  //  pitch_offset = (angle_offset[0] - 0.9) * M_PI / 180 ;
  //  yaw_offset = (angle_offset[1]+0.4) * M_PI / 180;
  // }
  ...
  // }
   pitch_offset = (angle_offset[0]-0.9) * M_PI / 180 ;
   yaw_offset = (angle_offset[1]) * M_PI / 180;
