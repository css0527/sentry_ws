...
: Node("armor_solver", options), solver_(nullptr) {
  ...
  measure_pub_ = this->create_publisher<auto_aim_interfaces::msg::Measurement>("armor_solver/measurement",
                                                                         rclcpp::SensorDataQoS());

  // Publisher
  target_pub_ = this->create_publisher<auto_aim_interfaces::msg::Target>("armor_solver/target",
                                                                   rclcpp::SensorDataQoS());
  gimbal_pub_ = this->create_publisher<auto_aim_interfaces::msg::GimbalCmd>("armor_solver/cmd_gimbal",
                                                                      rclcpp::SensorDataQoS());
  // Timer 250 Hz
...
void ArmorSolverNode::armorsCallback(const auto_aim_interfaces::msg::Armors::SharedPtr armors_msg) {
...
void ArmorSolverNode::publishMarkers(const auto_aim_interfaces::msg::Target &target_msg,
