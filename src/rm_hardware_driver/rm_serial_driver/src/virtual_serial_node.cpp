...
public:
  explicit VirtualSerialNode(const rclcpp::NodeOptions &options) : Node("serial_driver", options) {
    ...
    serial_receive_data_pub_ =
      this->create_publisher<auto_aim_interfaces::msg::SerialReceiveData>("serial/receive", 10);
...
private:
  ...
  rclcpp::Publisher<auto_aim_interfaces::msg::SerialReceiveData>::SharedPtr serial_receive_data_pub_;
  rclcpp::TimerBase::SharedPtr timer_;
  auto_aim_interfaces::msg::SerialReceiveData serial_receive_data_msg_;
