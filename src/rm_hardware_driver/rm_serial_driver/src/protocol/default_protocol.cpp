...
std::vector<rclcpp::SubscriptionBase::SharedPtr> DefaultProtocol::getSubscriptions(
  ...
  return {node->create_subscription<auto_aim_interfaces::msg::GimbalCmd>(
...
std::vector<rclcpp::Client<auto_aim_interfaces::srv::SetMode>::SharedPtr> DefaultProtocol::getClients(
  rclcpp::Node::SharedPtr node) const {
  return {node->create_client<auto_aim_interfaces::srv::SetMode>("armor_detector/set_mode",
                                                           rmw_qos_profile_services_default)};
}

void DefaultProtocol::send(const auto_aim_interfaces::msg::GimbalCmd &data) {
...
void DefaultProtocol::send(const rm_interfaces::msg::ChassisCmd &data) {

}

bool DefaultProtocol::receive(auto_aim_interfaces::msg::SerialReceiveData &data) {
  FixedPacket<16> packet;
