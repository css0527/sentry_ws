...
#include "rm_interfaces/msg/robot_mode.hpp"
...
public:
  ...
  void send(const auto_aim_interfaces::msg::GimbalCmd &data) override;

  void send(const rm_interfaces::msg::ChassisCmd &data) ;

  void send(const rm_interfaces::msg::RobotMode &data);

  bool receive(auto_aim_interfaces::msg::SerialReceiveData &data) override;

  std::vector<rclcpp::SubscriptionBase::SharedPtr> getSubscriptions(rclcpp::Node::SharedPtr node) override;

  std::vector<rclcpp::Client<auto_aim_interfaces::srv::SetMode>::SharedPtr> getClients(
...
private:
  ...
  auto_aim_interfaces::msg::ChassisCmd chassis_cmd_;
