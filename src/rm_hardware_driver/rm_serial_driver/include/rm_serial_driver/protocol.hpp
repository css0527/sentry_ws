...
// project
#include "auto_aim_interfaces/msg/chassis_cmd.hpp"
#include "auto_aim_interfaces/msg/gimbal_cmd.hpp"
#include "auto_aim_interfaces/msg/serial_receive_data.hpp"
...
public:
  ...
  // Send gimbal command
  virtual void send(const auto_aim_interfaces::msg::GimbalCmd &data) = 0;

  // Receive data from serial port
  virtual bool receive(auto_aim_interfaces::msg::SerialReceiveData &data) = 0;
  ...
  virtual std::vector<rclcpp::Client<auto_aim_interfaces::srv::SetMode>::SharedPtr> getClients(
